...
class Mailer
{
    ...
    public static function sendRegistrationEmail($recipientEmail) {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom($smtpUsername, 'VanValinMagic');
            $mail->addAddress($recipientEmail);
            $mail->addReplyTo($smtpUsername, 'NoReply');

            //Content
            $body = '<p>Greetings! An account was recently created on <a href="https://cory2v.com">cory2v.com</a> using this email address</p>';
            $body = $body . '<br/><p>If you believe you have received this message in error, please contact our <a href="mailto:info@cory2v.com">Support</a>.</p>';

            $mail->isHTML(true);                                  // Set email format to HTML
            $mail->Subject = 'Van Valin Magic Registration Successful';
            $mail->Body    = $body;
    ...
    public static function sendContactEmail($email_address,$email_subject,$email_body) {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom($email_address,"cory2 User");
    ...
    public static function sendGenericEmail($email_address,$email_subject,$email_body) {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom($smtpUsername,"cory2v User");
            $mail->addAddress($email_address);
            $mail->addReplyTo($smtpUsername,"cory2v");
